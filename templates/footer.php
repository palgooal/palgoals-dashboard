        ...
        <div class="grid grid-cols-12 gap-1.5">
          <div class="col-span-12 sm:col-span-6 my-1">
            <p class="m-0"></p>
              ...
              <a href="https://themeforest.net/user/phoenixcoded" class="text-theme-bodycolor dark:text-themedark-bodycolor hover:text-primary-500 dark:hover:text-primary-500" target="_blank">Phoenixcoded</a>
            </p>
          </div>
          <div class="col-span-12 sm:col-span-6 my-1">
