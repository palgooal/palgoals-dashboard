              ...
              <div class="card-body relative z-20">
                <div class="grid grid-cols-12 gap-6">
                  ...
                  <div class="col-span-12 sm:col-span-6 text-center">
                    <img src="../assets/images/widget/welcome-banner.png" alt="img" class="img-fluid w-[200px] max-w-full mx-auto" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-span-12 md:col-span-6 2xl:col-span-3">
            <div class="card">
              <div class="card-body">
                <div class="flex items-center">
                  <div class="shrink-0">
                    <div class="w-10 h-10 rounded-xl inline-flex items-center justify-center bg-danger-500/10 text-danger-500">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
          ...
          <div class="col-span-12 lg:col-span-9">
            <div class="card">
              <div class="card-body">
                ...
                <h5 class="ltr:text-right rtl:text-left my-2">5.44% <span class="badge bg-success-500 text-white">+2.6%</span> </h5>
          ...
          <div class="col-span-12 lg:col-span-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="grid gap-3">
                  <a href="#" class="btn btn-link-secondary">
                    <div class="flex align-items-center">
                      <div class="shrink-0">
                        <span class="rounded-full w-2.5 h-2.5 inline-block bg-warning-500"></span>
                      </div>
                      <div class="grow-1 mx-2">
                        <p class="mb-0 grid text-left">
                          <span class="truncate w-full">Horizontal Layout</span>
                        </p>
                      </div>
                      <div class="badge inline-flex gap-1 bg-secondary-500/10 text-secondary-500 text-sm"><i class="ti ti-paperclip text-sm"></i> 2</div>
                    </div>
                  </a>
                  <a href="#" class="btn btn-link-secondary">
                    <div class="flex align-items-center">
                      ...
                      <div class="grow-1 mx-2">
                        <p class="mb-0 grid text-left">
                          <span class="truncate w-full">Invoice Generator</span>
                        </p>
                      </div>
                    </div>
                  </a>
                  <a href="#" class="btn btn-link-secondary">
                    <div class="flex align-items-center">
                      ...
                      <div class="grow-1 mx-2">
                        <p class="mb-0 grid text-left">
                          <span class="truncate w-full">Figma Auto Layout </span>
                        </p>
                      </div>
                    </div>
                  </a>
                ...
                <div class="grid mt-3">
                  <button class="btn btn-primary flex items-center justify-center gap-3"
              ...
              <div class="card-body">
                ...
                <div class="grid grid-cols-12 gap-6 mt-3">
                  ...
                  <div class="col-span-12 md:col-span-6 xl:col-span-4 self-center">
                    <div class="grid">
                      <button class="btn btn-primary dflex align-center justify-center"
          ...
          <div class="col-span-12 lg:col-span-3">
            <div class="card">
              <div class="card-body">
                <div class="flex items-center">
                  <div class="shrink-0">
                    <div class="w-8 h-8 rounded-xl inline-flex items-center justify-center bg-primary-500/10 text-primary-500">
                ...
                <div class="flex items-center justify-between mt-4">
                  <div class="flex -space-x-2 overflow-hidden *:flex *:items-center *:justify-center *:rounded-full *:w-[30px] *:h-[30px] hover:*:z-10 *:border-2 *:border-white">
                  ...
                  <a href="#" class="w-10 h-10 inline-flex items-center justify-center btn btn-primary rounded-full">
                    <i class="ti ti-plus text-xl leading-none"></i>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-span-12 md:col-span-6">
            <div class="card">
              <div class="card-body border-bottom pb-0">
                ...
                <ul class="flex flex-wrap w-full text-center nav-tabs border-b border-theme-border dark:border-themedark-border">
                ...
                <div class="block tab-pane" id="tran-1">
                  <ul class="rounded-lg *:py-4 *:px-[25px] divide-y divide-inherit border-theme-border dark:border-themedark-border">
                    <li class="list-group-item">
                      <div class="flex items-center">
                        <div class="shrink-0">
                          <div class="w-10 h-10 rounded-xl inline-flex items-center justify-center border border-theme-border dark:border-themedark-border"> AI </div>
                        </div>
                        <div class="grow ltr:ml-3 rtl:mr-3">
                          <div class="grid grid-cols-12 gap-2">
                            ...
                            <div class="col-span-6 ltr:text-right rtl:text-left">
                              ...
                              <p class="text-danger-500 mb-0"><i class="ti ti-arrow-down-left"></i> 10.6%</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <li class="list-group-item">
                      <div class="flex items-center">
                        <div class="shrink-0">
                          <div class="w-10 h-10 rounded-xl inline-flex items-center justify-center border border-theme-border dark:border-themedark-border"> SM </div>
                        </div>
                        <div class="grow ltr:ml-3 rtl:mr-3">
                          <div class="grid grid-cols-12 gap-2">
                            <div class="col-span-6">
                            ...
                            <div class="col-span-6 ltr:text-right rtl:text-left">
                              ...
                              <p class="text-success-500 mb-0"><i class="ti ti-arrow-down-right"></i> 30.6%</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <li class="list-group-item">
                      <div class="flex items-center">
                        <div class="shrink-0">
                          <div class="w-10 h-10 rounded-xl inline-flex items-center justify-center border border-theme-border dark:border-themedark-border"> MD </div>
                        </div>
                        <div class="grow ltr:ml-3 rtl:mr-3">
                          <div class="grid grid-cols-12 gap-2">
                            <div class="col-span-6">
                    ...
                    <li class="list-group-item">
                      <div class="flex items-center">
                        <div class="shrink-0">
                          <div class="w-10 h-10 rounded-xl inline-flex items-center justify-center border border-theme-border dark:border-themedark-border"> U </div>
                        </div>
                        <div class="grow ltr:ml-3 rtl:mr-3">
                          <div class="grid grid-cols-12 gap-2">
                            <div class="col-span-6">
                    ...
                    <li class="list-group-item">
                      <div class="flex items-center">
                        <div class="shrink-0">
                          <div class="w-10 h-10 rounded-xl inline-flex items-center justify-center border border-theme-border dark:border-themedark-border"> OC </div>
                        </div>
                        <div class="grow ltr:ml-3 rtl:mr-3">
                          <div class="grid grid-cols-12 gap-2">
                            <div class="col-span-6">
              ...
              <div class="card-footer">
                <div class="grid grid-cols-12 gap-2">
                  <div class="col-span-12 md:col-span-6">
                    <div class="grid">
                      <button class="btn btn-outline-secondary grid"
                        ><span class="truncate w-full">View all Transaction History</span></button
                      >
                    </div>
                  </div>
                  <div class="col-span-12 md:col-span-6">
                    <div class="grid">
                      <button class="btn btn-primary grid"><span class="truncate w-full">Create new Transaction</span></button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="grid grid-cols-12 gap-3 mt-4">
                  <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                      <p class="mb-1 relative inline-flex items-center gap-2"><span class="rounded-full w-2 h-2 inline-block bg-primary-500"></span><span>Item01</span></p>
                      <h6 class="mb-0">$23,876 <small class="text-muted"><i class="ti ti-chevrons-up"></i> +$763,43</small></h6>
                    </div>
                  </div>
                  <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                      <p class="mb-1 relative inline-flex items-center gap-2"><span class="rounded-full w-2 h-2 inline-block bg-warning-500"></span><span>Item02</span></p>
                      <h6 class="mb-0">$23,876 <small class="text-muted"><i class="ti ti-chevrons-up"></i> +$763,43</small></h6>
                    </div>
                  </div>
                  <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                      <p class="mb-1 relative inline-flex items-center gap-2"><span class="rounded-full w-2 h-2 inline-block bg-success-500"></span><span>Item03</span></p>
                      <h6 class="mb-0">$23,876 <small class="text-muted"><i class="ti ti-chevrons-up"></i> +$763,43</small></h6>
                    </div>
                  </div>
                  <div class="col-span-12 sm:col-span-6">
                    <div class="p-4 rounded-lg bg-theme-bodybg dark:bg-themedark-bodybg">
                      <p class="mb-1 relative inline-flex items-center gap-2"><span class="rounded-full w-2 h-2 inline-block bg-info-500"></span><span>Item04</span></p>
                      <h6 class="mb-0">$23,876 <small class="text-muted"><i class="ti ti-chevrons-up"></i> +$763,43</small></h6>
                    </div>
                  </div>
                </div>
